...
async function createTables() {
  try {
    ...
    const sqlCreateInventory = "CREATE TABLE IF NOT EXISTS  inventory (id int AUTO_INCREMENT,category VARCHAR(20), title VARCHAR(50),src VARCHAR(50), PRIMARY KEY(id));";
    const sqlInsertInventory = "INSERT INTO inventory (category, title, src) VALUES ('electronics', 'Smartphone', 'https://example.com/smartphone.jpg'), ('electronics', 'Laptop', 'https://example.com/laptop.jpg'), ('furniture', 'Sofa', 'https://example.com/sofa.jpg'), ('furniture', 'Dining Table', 'https://example.com/dining-table.jpg');";
    ...
    const sqlInsertPrices = "INSERT INTO prices (category, size, price) VALUES ('electronics', '10*10', 699), ('electronics', '10*20', 999), ('furniture', '20*30', 499), ('furniture','5*5', 799);";
