...
async function createTables() {
  try {
    ...
    const sqlCreatePrices = "CREATE TABLE IF NOT EXISTS prices (category VARCHAR(20) REFERENCES inventory(category), size VARCHAR(10), price FLOAT,type VARCHAR(25), PRIMARY KEY(category, size));"
    const sqlInsertPrices = "INSERT INTO prices (category, size, price,type) VALUES ('invitations', '10*10', 2, 'בריסטול קרם'), ('invitations', '10*20', 3, 'בריסטול קרם'), ('furniture', '20*30', 499, ''), ('furniture','5*5', 799, '');";
